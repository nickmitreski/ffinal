...
const WebDesignWorkPopup: React.FC<WebDesignWorkPopupProps> = ({ onClose }) => {
  ...
  const [showAllThumbnails, setShowAllThumbnails] = useState(true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showAllThumbnails ? (
          <div className="p-6">
            <h3 className="text-white text-xl font-light mb-6">Our Website Projects</h3>
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                      <div className="p-4 w-full">
                        <h4 className="text-white font-light text-lg mb-1">{project.title}</h4>
                        <p className="text-gray-300 text-sm line-clamp-2">{project.description.substring(0, 80)}...</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative aspect-video bg-black/50 rounded-lg overflow-hidden border border-gray-800">
                    ...
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        const prevIndex = (currentProject - 1 + websiteProjects.length) % websiteProjects.length;
                    ...
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        const nextIndex = (currentProject + 1) % websiteProjects.length;
        ...
        <div className="p-6 border-t border-gray-800 flex justify-between">
          {!showAllThumbnails && (
            <button 
              ...
              className="px-6 py-2 bg-gray-800 text-white rounded-md transition-colors duration-300 text-sm font-light tracking-tight"
            >
              View All Projects
            </button>
          )}
